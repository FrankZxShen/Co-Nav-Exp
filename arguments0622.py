...
def get_args():
    ...
    parser.add_argument('--save_interval', type=int, default=1,
                        help="""save interval""")
    parser.add_argument('-d', '--dump_location', type=str, default="./tmp_panorama/",
                        help='path to dump models and log (default: ./tmp_panorama/)')
    ...
    parser.add_argument('--vlm_model_id', type=str, default='/home/szx/project/Co-NavGPT/vlm_models/prism-dinosiglip+7b')
