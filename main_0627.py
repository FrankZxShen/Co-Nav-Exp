...
######################################################################################################################
                ...
                if len(full_target_point_map) > 0:
                    ...
                    for j in range(num_agents):
                        ...
                        if len(agent_TargetPointMap[j]) > 0:
                            ...
                            if FN_PR[0] >= 0.3 or agent[j].l_step <= 100:
                            ...
                            # Agent States
                            c_angle = int(start_o % 360)
                            angle_score = Perception_PR[0] * 0.50
            ...
            # 判断距离，如果互相太远就交换
            if num_agents == 2:
                distance_1_0 = calculate_distance(goal_points[0], cur_goal_points[0])
                distance_1_1 = calculate_distance(goal_points[0], cur_goal_points[1])
                if distance_1_1 < distance_1_0:
