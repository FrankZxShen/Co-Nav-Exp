...
def main():
    ...
    while count_episodes < num_episodes:
        ...
        print("lenobservations:",len(observations))
        ...
        while not env.episode_over:
            ...
            for i in range(num_agents):
                ...
                print(agent[i].local_map.shape)#[20,480,480]
                ...
                print("agent[i].planner_pose_inputs:",agent[i].planner_pose_inputs.shape)
            ...
            # print(full_map2.shape)#[2, 20, 480, 480]
            # print(full_map_pred.shape)#[20, 480, 480]
            ...
            if agent[0].l_step % args.num_local_steps == args.num_local_steps - 1 or agent[0].l_step == 0:
                ...
                print("target_edge_map:",target_edge_map)
                print("target_point_map",target_point_map)
