...
class VLM:
    def __init__(self, model_id, hf_token, device):
        start_time = time.time()
        self.model = load(model_id, hf_token=hf_token)
    ...
    def get_loss(self, image, prompt, tokens, get_smx=False, T=1):
...
class CogVLM2:
    ...
    def TOT3(self, User_Prompt1, User_Prompt2, cot_pred1, return_string_probabilities=None, use_stream=False, img=None):
        """
        Facilitates a simple chat interaction involving an image.
